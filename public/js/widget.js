...
function chat_end(){
	$.ajax({
		...
		success: function(data){
			...
			$(".live_chat_widget .chat_area").css("height","372px");	
		}
	});
}
...
$(window).on('load', function(e) {
	if($(".live_chat_widget").height() != 423){
		$(".live_chat_widget .chat_area").css("height",$(window).height()-175);
	}
});
